...
private:
  ...
  double _r_cut;        // Cutoff radius for pair interactions ( distanza massima entro la quale vengono considerate le interazioni tra le particelle in un sistema simulato. Oltre questa distanza, le interazioni vengono approssimate a zero e non vengono considerate nel calcolo delle forze)
